    ...
    <div class="w-full max-w-md bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
        ...
        <form action="<?php echo e(route('login.post')); ?>" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" class="w-full border border-gray-200 px-4 py-3 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none" required>
            </div>
